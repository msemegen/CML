...
CFLAGS += -D$(MCU_ARCH) -D$(MCU_FAMILY) -D$(MCU_TYPE) -D$(MCU_MODEL) -DARM_MATH_CM4 -DARM_MATH_ROUNDING -D__FPU_PRESENT
...
C_OBJECTS_RELEASE := $(patsubst %.c, %.o,$(addprefix $(OUTDIR_RELEASE), $(subst $(ROOT)/..,,$(C_SOURCE_FILES))))
C_OBJECTS_DEBUG   := $(patsubst %.c, %.o,$(addprefix $(OUTDIR_DEBUG), $(subst $(ROOT)/..,,$(C_SOURCE_FILES))))

CPP_SOURCE_FILES    := $(wildcard $(addsuffix /*.cpp, $(CPP_SOURCE_PATHS)))
CPP_OBJECTS_RELEASE := $(patsubst %.cpp, %.o,$(addprefix $(OUTDIR_RELEASE), $(subst $(CML_ROOT),,$(CPP_SOURCE_FILES))))
CPP_OBJECTS_DEBUG   := $(patsubst %.cpp, %.o,$(addprefix $(OUTDIR_DEBUG), $(subst $(CML_ROOT),,$(CPP_SOURCE_FILES))))
...
MAIN_LDFLAGS_COMMON  +=-T$(LD_PATH)/$(MCU_MODEL)_FLASH.ld -lgcc -fno-exceptions -fno-rtti -Wl,--gc-sections
...
$(OUTPUT_NAME).elf : $(CPP_OBJECTS_RELEASE)
...
$(CPP_OBJECTS_RELEASE): $(OUTDIR_RELEASE)/%.o : $(CML_ROOT)/%.cpp
	@bash -c 'echo -e $<" \e[01;32m[compiling]\e[0m"'
	mkdir -p $(dir $@)
...
$(CPP_OBJECTS_DEBUG): $(OUTDIR_DEBUG)/%.o : $(CML_ROOT)/%.cpp
	@bash -c 'echo -e $<" \e[01;32m[compiling]\e[0m"'
	mkdir -p $(dir $@)
