...
static inline uint8 cstring_dec_to_uint8(const char* a_p_string)
{
    ...
    assert(cstring_length(a_p_string, 4) < 4); //max: strlen("255") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 5) < 5); //max: strlen("-255") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 6) < 6); //max: strlen("65536") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 7) < 7); //max: strlen("-65535") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 11) < 11); //max: strlen("4294967295") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 12) < 12); // max: strlen("-2147483648") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 21) < 21); //max: strlen("18446744073709551615") + 1
...
{
    assert(nullptr != a_p_string && 0 != a_p_string[0]);
    assert(cstring_length(a_p_string, 22) < 22); // max: strlen("-9223372036854775808") + 1
