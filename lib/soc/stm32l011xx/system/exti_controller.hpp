...
public:
    ...
    enum class Interrupt_mode : cml::uint32
    {
        rising  = 0x1,
        falling = 0x2,
    };
...
public:
    ...
    static void enable(cml::uint32 a_priority);
    static void disable();
...
{
    return static_cast<exti_controller::Interrupt_mode>(static_cast<cml::uint32>(a_f1) |
                                                        static_cast<cml::uint32>(a_f2));
}
