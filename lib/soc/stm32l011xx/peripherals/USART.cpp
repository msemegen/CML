                   ...
                   time::tick a_timeout_ms)
{
    ...
    return wait_until::flag(&(USART2->ISR), wait_flag, false, start, a_timeout_ms);
}
                   ...
                   time::tick a_timeout)
{
    ...
    bool ret =
        wait_until::flag(&(USART2->ISR), USART_ISR_TEACK | USART_ISR_REACK | USART_ISR_RWU, false, start, a_timeout);
