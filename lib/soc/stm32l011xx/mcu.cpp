                                    ...
                                    Voltage_scaling a_voltage_scaling)
{
    ...
    internal_flash::Latency new_flash_latency     = select_flash_latency(a_frequency_hz, a_voltage_scaling);
    Voltage_scaling current_voltage_scaling       = get_voltage_scaling();
    internal_flash::Latency current_flash_latency = internal_flash::get_latency();
