...
public:
...
#if defined(STM32L431xx) || defined(STM32L432xx) || defined(STM32L433xx) || defined(STM32L442xx) || \
    defined(STM32L443xx) || defined(STM32L451xx) || defined(STM32L452xx) || defined(STM32L462xx)
        template<Clock clock> static void enable_clock(PLL_source a_source,
                                                       PLLM a_m,
    ...
    template<>
    void rcc<mcu>::enable_clock<rcc<mcu>::Clock::PLL>(PLL_source a_source, PLLM a_m, const PLL_config& a_config);
