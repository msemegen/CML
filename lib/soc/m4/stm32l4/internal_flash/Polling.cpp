...
// this
#include <soc/m4/stm32l4/internal_flash/Polling.hpp>

// std
#include <cstring>

// soc
#include <soc/m4/stm32l4/internal_flash/common.hpp>
...
Polling<internal_flash>::Result::Status_flag get_status_flag_from_FLASH_SR()
{
    uint32_t SR = (FLASH->SR & 0x3F8u);
    return static_cast<Polling<internal_flash>::Result::Status_flag>(SR);
}
...
Polling<internal_flash>::Result Polling<internal_flash>::write(uint32_t a_address,
...
Polling<internal_flash>::Result
Polling<internal_flash>::read(uint32_t a_address, void* a_p_data, uint32_t a_size_in_bytes)
{
    cml_assert(a_address >= internal_flash::start_address &&
               a_address <= internal_flash::start_address + internal_flash::size_in_bytes);
    cml_assert(nullptr != a_p_data);
...
Polling<internal_flash>::Result
Polling<internal_flash>::read(uint32_t a_address, void* a_p_data, uint32_t a_size_in_bytes, uint32_t a_timeout)
{
    cml_assert(a_address >= internal_flash::start_address &&
               a_address <= internal_flash::start_address + internal_flash::size_in_bytes);
    cml_assert(nullptr != a_p_data);
...
Polling<internal_flash>::Result Polling<internal_flash>::erase_page(uint32_t a_page_address)
{
...
Polling<internal_flash>::Result Polling<internal_flash>::erase_page(uint32_t a_page_address, uint32_t a_timeout)
{
    cml_assert(a_page_address >= internal_flash::start_address &&
               a_page_address <= internal_flash::start_address + internal_flash::size_in_bytes);
    cml_assert(a_timeout > 0);
...
Polling<internal_flash>::Result Polling<internal_flash>::erase_bank(Bank_id)
{
    Unlock_guard unlock_guard;
...
Polling<internal_flash>::Result Polling<internal_flash>::erase_bank(Bank_id, uint32_t a_timeout)
{
    cml_assert(a_timeout > 0);
