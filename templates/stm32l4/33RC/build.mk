...
CFLAGS += -D$(MCU_FAMILY) -D$(MCU_TYPE) -DARM_MATH_CM4 -DARM_MATH_ROUNDING -D__FPU_PRESENT -DCML_DWT_PRESENT
...
MAIN_LDFLAGS_COMMON  +=-T$(LD_PATH)/STM32L433RCTxP_FLASH.ld -lgcc -fno-exceptions -fno-rtti -Wl,--gc-sections
